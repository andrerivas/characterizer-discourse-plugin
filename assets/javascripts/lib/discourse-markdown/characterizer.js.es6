...
function characterizer(text, opts) {
  ...
  text = text.replace(/\b(rapp)|(Rapalapaskank)\b/ig, "<a href='/users/sean' class='mention'>Rapp</a>")
              ...
              .replace(/\b(BE)\b/g, "<a href='/users/keith' class='mention'>Browneye</a>").replace(/\b(browneye|brown eye|tight butthole)\b/ig, "<a href='/users/keith' class='mention'>Browneye</a>")
